...
import { protectRoute , authorizeRoles , authorizeUpdateLog , createLogAuthorization } from "../middleware/auth.middleware.js";
...
// Routes
router.post("/", protectRoute, createLogAuthorization, createCallLog);       // Create new log
